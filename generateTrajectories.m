function trajectories = generateTrajectories( problems, trajectory_type )
%
%     trajectories = generateTrajectories(problem)
%     trajectories = generateTrajectories(problem, trajectory_type)
%     trajectories = generateTrajectories({problem1,problem2,...})
%     trajectories = generateTrajectories({problem1,problem2,...}, trajectory_type)
%
