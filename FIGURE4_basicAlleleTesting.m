function FIGURE4_basicAlleleTesting(regenerate)
...
plotRMSEBoxplot( struct('l2_mat', obsl2_mat), x_txts, [title_txt,', Observation'], 'FIG3a_observedRMSE', save_figs, false);
plotRMSEBoxplot( struct('l2_mat', predl2_mat), x_txts, [title_txt,', Forecasting'], 'FIG3a_forecastRMSE', save_figs, false);
...
for m = 1:N_methods
    ...
    plotRMSEBoxplot( struct('l2_mat',simResults.obsl2_mat,'l2_perfect',simResults.obsl2_perfect), x_txts, [method_txts{m},', Observed'], ['FIGS_',data_methodnames{m},'_observedRMSE'], save_figs, true);
    plotRMSEBoxplot( struct('l2_mat',simResults.predl2_mat,'l2_perfect',simResults.predl2_perfect), x_txts, [method_txts{m},', Forecasting'], ['FIGS_',data_methodnames{m},'_forecastRMSE'], save_figs, true);
